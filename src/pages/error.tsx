    ...
    <div className="w-screen min-h-screen flex gap-4 items-center justify-center bg-slate-900 overflow-hidden">
      <div className="p-5">
        ...
        <div className="flex flex-col md:flex-row gap-3 mt-10">
          <a
            href=""
            className="relative inline-flex flex-shrink-0 cursor-pointer items-center justify-center rounded border-none text-sm dark:bg-slate-600 px-8 py-3 font-bold dark:text-slate-100 transition-colors duration-200 ease-in-out dark:hover:bg-slate-700"
          >
            Tentar novamente
          </a>
          ...
          <a
            href="/"
            className="relative inline-flex flex-shrink-0 cursor-pointer items-center justify-center rounded border-none text-sm dark:bg-lime-600 px-8 py-3 font-bold dark:text-slate-100 transition-colors duration-200 ease-in-out dark:hover:bg-lime-700"
          >
            Retornar à home
          </a>
        </div>
